    ...
    <div className="flex flex-col items-center justify-center my-[120px] gap-4">
      <div className="flex  lg:gap-5">
        <div className="flex flex-col justify-center items-center gap-4 relative ">
          ...
          />
          <h1 className="ml-16 lg:ml-32 text-[20px] lg:text-[24px] font-nohemi_m bg-gradient-to-r from-slate-400 to-cyan-900 text-transparent bg-clip-text">Software Developer</h1>
        </div>
        <div className="mt-4">
